...
public class ActorScopeRequestRecordPage extends AbstractPageContainerManagedImpl implements Serializable {
		...
		saveCommandButton = CommandButton.build(CommandButton.FIELD_VALUE,"Enregistrer",CommandButton.FIELD_ICON,"fa fa-floppy-o"
				...
				,CommandButton.FIELD_LISTENER,new CommandButton.Listener.AbstractImpl() {
					...
					protected Object __runExecuteFunction__(AbstractAction action) {
						return save(actorsAutoComplete, scopesAutoComplete);
					}
				});
	...
	public static Object save(AutoComplete actorsAutoComplete,AutoComplete scopesAutoComplete) {
		return save((Collection<Actor>) actorsAutoComplete.getValue(), (Collection<Scope>) scopesAutoComplete.getValue());
	}
	
	public static Object save(Collection<Actor> actors,Collection<Scope> scopes) {
		...
		Arguments<ActorScopeRequest> arguments = new Arguments<ActorScopeRequest>().setResponseEntityClass(String.class).addCreatablesOrUpdatables(new ActorScopeRequest()

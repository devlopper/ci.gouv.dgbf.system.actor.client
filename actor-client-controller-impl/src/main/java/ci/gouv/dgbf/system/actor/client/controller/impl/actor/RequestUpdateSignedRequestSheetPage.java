...
public class RequestUpdateSignedRequestSheetPage extends AbstractRequestUpdateFilePage implements Serializable {

	@Override
	protected String getFileType() {
		return "spécimen de signature";
	}
	...
	public static Form buildForm(Map<Object, Object> arguments) {
		...
		MapHelper.writeByKeyDoNotOverride(arguments,AbstractRequestUpdateFilePage.Data.FIELD_FILE, Request.FIELD_SIGNED_REQUEST_SHEET);
	...
	public static final String OUTCOME = "requestUpdateSignedRequestSheetView";
}
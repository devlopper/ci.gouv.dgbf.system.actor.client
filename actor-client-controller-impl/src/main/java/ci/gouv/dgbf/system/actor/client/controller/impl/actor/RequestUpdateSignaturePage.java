...
public class RequestUpdateSignaturePage extends AbstractRequestUpdateFilePage implements Serializable {
	...
	public static Form buildForm(Map<Object, Object> arguments) {
		...
		MapHelper.writeByKeyDoNotOverride(arguments,AbstractRequestUpdateFilePage.Data.FIELD_FILE, Request.FIELD_SIGNATURE);
	...
	public static class FormListener extends AbstractRequestUpdateFilePage.AbstractFormListener {
		...
		protected void act(Form form, Request request) {
			RequestRepresentation.getProxy().recordSignatureByIdentifier(request.getIdentifier(), request.getActOfAppointment());
		}
	}
	...
	public static final String OUTCOME = "requestUpdateSignatureView";
}
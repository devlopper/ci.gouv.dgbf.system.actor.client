...
public class ActorProfileCreateManyPage extends AbstractActorProfileCreateOrDeleteManyPage implements Serializable {

	@Override
	protected String getActionIdentifier() {
		return ActorBusiness.CREATE_PROFILES;
	}
}
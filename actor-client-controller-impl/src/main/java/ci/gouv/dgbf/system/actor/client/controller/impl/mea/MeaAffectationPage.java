...
import ci.gouv.dgbf.system.actor.client.controller.impl.scope.ScopeFunctionListPage;
import ci.gouv.dgbf.system.actor.server.persistence.api.query.FunctionQuerier;
import lombok.Getter;
import lombok.Setter;

@Named @ViewScoped @Getter @Setter
public class MeaAffectationPage extends AbstractPageContainerManagedImpl implements MeaTheme,Serializable {

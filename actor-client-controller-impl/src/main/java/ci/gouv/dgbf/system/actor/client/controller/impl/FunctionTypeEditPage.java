...
public class FunctionTypeEditPage extends AbstractEntityEditPageContainerManagedImpl<FunctionType> implements Serializable {
	...
	protected Map<Object, Object> __getFormArguments__() {
		...
		arguments.put(Form.ConfiguratorImpl.FIELD_LISTENER, new Form.ConfiguratorImpl.Listener.AbstractImpl() {
			...
			public Collection<String> getFieldsNames(Form form) {
				return CollectionHelper.listOf(FunctionType.FIELD_CODE,FunctionType.FIELD_NAME);
			}

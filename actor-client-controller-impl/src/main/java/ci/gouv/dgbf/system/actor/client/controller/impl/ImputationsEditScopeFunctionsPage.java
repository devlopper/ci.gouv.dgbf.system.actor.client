...
public class ImputationsEditScopeFunctionsPage extends AbstractPageContainerManagedImpl implements Serializable {
	...
	protected String __getWindowTitleValue__() {
		return "Assignation de fonction";
	}
	...
	private void buildDataTable() {
		//imputationsDataTable = ActivityListPage.buildDataTable(DataTable.FIELD_LISTENER,new DataTableListenerImpl(),DataTable.ConfiguratorImpl.FIELD_LAZY_DATA_MODEL_LISTENER

...
public class RequestUpdateActOfAppointmentPage extends AbstractRequestUpdateFilePage implements Serializable {

	@Override
	protected String getFileType() {
		return "acte de nomination";
	}
	...
	public static Form buildForm(Map<Object, Object> arguments) {
		...
		MapHelper.writeByKeyDoNotOverride(arguments,AbstractRequestUpdateFilePage.Data.FIELD_FILE, Request.FIELD_ACT_OF_APPOINTMENT);
	...
	public static class FormListener extends AbstractRequestUpdateFilePage.AbstractFormListener {
		...
		protected void act(Form form, Request request) {
			RequestRepresentation.getProxy().recordActOfAppointmentByIdentifier(request.getIdentifier(), request.getActOfAppointment());
		}
	}
	...
	public static final String OUTCOME = "requestUpdateActOfAppointmentView";
}
...
@Getter @Setter
public abstract class AbstractRequestIndexPage extends AbstractPageContainerManagedImpl implements Serializable {
	...
	protected void __listenBeforePostConstruct__() {
		...
		requestFilterController.initialize();	
	}
	...
	private DataTable buildDataTableRequestsToProcess() {
		...
		dataTable.setIsFilterControllerGettable(!requestFilterController.isAdministrativeUnitRequired() || requestFilterController.getAdministrativeUnitInitial() != null);
		return dataTable;
	}

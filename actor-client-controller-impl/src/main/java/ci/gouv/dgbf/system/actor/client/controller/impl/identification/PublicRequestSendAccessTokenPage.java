...
public class PublicRequestSendAccessTokenPage extends AbstractPageContainerManagedImpl implements IdentificationTheme,Serializable {
	...
	protected String __getWindowTitleValue__() {
		return "Obtenir un jeton d'accès";
	}
	...
	public static class FormConfiguratorListener extends Form.ConfiguratorImpl.Listener.AbstractImpl {
		...
		public Map<Object, Object> getCommandButtonArguments(Form form, Collection<AbstractInput<?>> inputs) {
			...
			map.put(CommandButton.FIELD_VALUE, "Obtenir");
			return map;
		}
	}
}
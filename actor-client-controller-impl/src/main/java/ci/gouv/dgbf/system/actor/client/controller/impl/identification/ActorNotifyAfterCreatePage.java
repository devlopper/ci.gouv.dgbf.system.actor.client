...
public class ActorNotifyAfterCreatePage extends AbstractPageContainerManagedImpl implements IdentificationTheme,Serializable {
	...
	protected void __listenPostConstruct__() {
		...
		message = String.format(StringUtils.join(List.of(
				...
				,"Une notification, contenant vos accès, vous a été envoyée à l'adresse mail %s"
